...
class UpdateSPNPRequestDetails extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'groups.*.work_weeks'   => 'numeric|gte:1',
            'groups.*.weekly_hours' => 'numeric|required_without:groups.*.period_hours',
            'groups.*.period_hours' => 'numeric|required_without:groups.*.weekly_hours',
