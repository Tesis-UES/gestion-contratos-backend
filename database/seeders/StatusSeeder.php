...
class StatusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Status::create(['code' => HiringRequestStatusCode::ODS, 'name' => 'Solicitud de contratación observada por Parte de Secretaria', 'description' => 'Se ha observado la solicitud de contratación por parte de secretaria de decanato, se ha enviado una notificación a la escuela para que se pueda corregir la solicitud.', 'order' => '5.1']);
