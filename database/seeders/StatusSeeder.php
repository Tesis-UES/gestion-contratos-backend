...
class StatusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Status::create(['code' => HiringRequestStatusCode::RDS, 'name' => 'Recepcioó solicitud de contratación por parte de Secretaria de Decanato.', 'description' => 'Se ha recibido la solicitud de contratacion por parte de secretaria de decanato y se ha agendado para discusión de Junta Directiva', 'order' => '5']);
