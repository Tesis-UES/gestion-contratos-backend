...
class StatusSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Status::create(['code' => HiringRequestStatusCode::ESD, 'name' => 'Enviado a Secretaría de Decanato', 'description' => 'Se ha enviado la solicitud de contratacion por parte de la escuela a decanato, Pendiente de dar por recibido', 'order' => '5']);
        Status::create(['code' => HiringRequestStatusCode::RDS, 'name' => 'Recepción solicitud de contratación por parte de Secretaria de Decanato', 'description' => 'Se ha recibido la solicitud de contratacion por parte de secretaria de decanato y se ha agendado para discusión de Junta Directiva', 'order' => '6']);
