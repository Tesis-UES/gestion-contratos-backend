...
class EscalafonSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Escalafon::create(['code'=>'PU-I'        ,'name'=>'PROFESOR UNIVERSITARIO I'     ,'salary'=> 1892 ]);
        Escalafon::create(['code'=>'PU-II'       ,'name'=>'PROFESOR UNIVERSITARIO II'    ,'salary'=> 2329 ]);
        Escalafon::create(['code'=>'PU-III'      ,'name'=>'PROFESOR UNIVERSITARIO III'   ,'salary'=> 2911 ]);
        Escalafon::create(['code'=>'PU-IV'       ,'name'=>'PROFESOR UNIVERSITARIO IV'    ,'salary'=> 3493 ]);
