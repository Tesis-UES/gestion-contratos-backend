...
class PersonSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        'bank_readable'=>true,
        'bank_number'=>true, 
        'curriculum_readable'=>true,
        'work_permission_readable'=>true,
        'passport_readable'=>true,
        'passport_name'=>true,
        'passport_number'=>true,
        'title_readable'=>true,
        'title_mined'=>true,
        'title_apostilled'=>true,
        'title_apostilled_readable'=>true,
        'title_authentic'=>true,
        'dui'=>true,
        'nit'=>true,
        'bank'=>true,
        'curriculum'=>true,
        ...
        'title'=>true,
       'carnet'=>true,
       'carnet_readable'=>true,
       'carnet_name'=>true,
       'carnet_number'=>true,
       'carnet_unexpired'=>true,
       'other_title'=>true,
